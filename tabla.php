...
function displayTable($sql){
   ...
   $pass = "Cable2016";
   $BD = "test";
   $sql = "select RF,codigoalarma,Activo,Descripcion,Referencia,Serie,Falla,Fabricante,Proveedor,Fecha,Resultado,MES from test.reportes where resuelto ='0'
";
...
<div>
  <form name="form1" action="reporteexcel.php"  method="post">
    <input type="submit" value="Descargar Reporte" class="boton">
  </form>
</div>

<div>
  <form name="form1" action="tablauser.php"  method="post">
